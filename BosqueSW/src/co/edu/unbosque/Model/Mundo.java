...
public class Mundo {
	...
	public String registrarEmpleado( String nombre, String apellido, String genero, long telefono, String correo,
			String direccion, String tipoIngeniero, String anoIngreso, long cedula, double salario, int variable,double  []salarios) throws Exception {
...
/*
			if (edad <= 17) {
			throw new Exception("La edad que ingreso no es valida");
